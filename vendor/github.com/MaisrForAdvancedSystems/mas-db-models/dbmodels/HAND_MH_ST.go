...
type HAND_MH_ST struct {
	...
	RECALC_ID             *int64     `gorm:"column:RECALC_ID;type:bigint;" json:"RECALC_ID" db:"RECALC_ID"`
	...
	CONN_STATUS           *int32     `gorm:"column:CONN_STATUS;type:INT;" json:"CONN_STATUS" db:"CONN_STATUS"`
}
...
func (h *HAND_MH_ST) Validate(action Action) error {
	return nil
}
