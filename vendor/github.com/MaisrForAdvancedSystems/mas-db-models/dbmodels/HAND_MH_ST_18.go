...
type HAND_MH_ST_18 struct {
	...
	//
	MODIFIED_AVRG_CONSUMP *float64 `gorm:"column:MODIFIED_AVRG_CONSUMP;type:float;" json:"MODIFIED_AVRG_CONSUMP" db:"MODIFIED_AVRG_CONSUMP"`

	CONN_AVRG_CONSUMP *float64 `gorm:"column:CONN_AVRG_CONSUMP;type:float;" json:"CONN_AVRG_CONSUMP" db:"CONN_AVRG_CONSUMP"`

	PR_AVRG_CONS *float64 `gorm:"column:PR_AVRG_CONS;type:float;" json:"PR_AVRG_CONS" db:"PR_AVRG_CONS"`

	STAMP_DATE *time.Time `gorm:"column:stamp_date;type:datetime;" json:"STAMP_DATE" db:"stamp_date"`

	STAMP_USER *string `gorm:"column:stamp_user;type:varchar;" json:"STAMP_USER" db:"stamp_user"`
}

// TableName sets the insert table name for this struct type
func (h *HAND_MH_ST_18) TableName() string {
	return "HAND_MH_ST"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (h *HAND_MH_ST_18) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (h *HAND_MH_ST_18) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (h *HAND_MH_ST_18) Validate(action Action) error {
	return nil
}
