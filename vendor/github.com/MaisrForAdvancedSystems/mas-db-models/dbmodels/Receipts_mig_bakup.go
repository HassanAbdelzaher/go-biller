...
type receipts_mig_bakup struct {
	//[ 0] RECEIPT_NO                                     NCHAR(30)            null: false  primary: true   isArray: false  auto: false  col: NCHAR           len: 30      default: []
	RECEIPT_NO string `gorm:"primary_key;column:RECEIPT_NO;type:NCHAR;size:30;" json:"RECEIPT_NO" db:"RECEIPT_NO"`
	...
	//[ 8] CHEQ_NO                                        NCHAR(60)            null: true   primary: false  isArray: false  auto: false  col: NCHAR           len: 60      default: []
	CHEQ_NO *string `gorm:"column:CHEQ_NO;type:NCHAR;size:60;" json:"CHEQ_NO" db:"CHEQ_NO"`
	//[ 9] CHEQ_BANK                                      NCHAR(120)           null: true   primary: false  isArray: false  auto: false  col: NCHAR           len: 120     default: []
	CHEQ_BANK *string `gorm:"column:CHEQ_BANK;type:NCHAR;size:120;" json:"CHEQ_BANK" db:"CHEQ_BANK"`
	...
	//[11] DISCOUNT_DOCUMENT_NO                           NCHAR(60)            null: true   primary: false  isArray: false  auto: false  col: NCHAR           len: 60      default: []
	DISCOUNT_DOCUMENT_NO *string `gorm:"column:DISCOUNT_DOCUMENT_NO;type:NCHAR;size:60;" json:"DISCOUNT_DOCUMENT_NO" db:"DISCOUNT_DOCUMENT_NO"`
	//[12] DOCUMENT_NO                                    NCHAR(60)            null: true   primary: false  isArray: false  auto: false  col: NCHAR           len: 60      default: []
	DOCUMENT_NO *string `gorm:"column:DOCUMENT_NO;type:NCHAR;size:60;" json:"DOCUMENT_NO" db:"DOCUMENT_NO"`
	...
	//[20] DEVICE_ID                                      NCHAR(120)           null: true   primary: false  isArray: false  auto: false  col: NCHAR           len: 120     default: []
	DEVICE_ID *string `gorm:"column:DEVICE_ID;type:NCHAR;size:120;" json:"DEVICE_ID" db:"DEVICE_ID"`
	//[21] STAMP_USER                                     NCHAR(60)            null: true   primary: false  isArray: false  auto: false  col: NCHAR           len: 60      default: []
	...
	//[26] POST_BY                                        NCHAR(120)           null: true   primary: false  isArray: false  auto: false  col: NCHAR           len: 120     default: []
	POST_BY *string `gorm:"column:POST_BY;type:NCHAR;size:120;" json:"POST_BY" db:"POST_BY"`
	...
	//[35] BILLGROUP                                      NCHAR(20)            null: true   primary: false  isArray: false  auto: false  col: NCHAR           len: 20      default: []
	BILLGROUP *string `gorm:"column:BILLGROUP;type:NCHAR;size:20;" json:"BILLGROUP" db:"BILLGROUP"`
	//[36] BOOK_NO                                        NCHAR(20)            null: true   primary: false  isArray: false  auto: false  col: NCHAR           len: 20      default: []
	BOOK_NO *string `gorm:"column:BOOK_NO;type:NCHAR;size:20;" json:"BOOK_NO" db:"BOOK_NO"`
	//[37] WALK_NO                                        NCHAR(20)            null: true   primary: false  isArray: false  auto: false  col: NCHAR           len: 20      default: []
...
func (r *receipts_mig_bakup) TableName() string {
	return "receipts_mig_bakup"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (r *receipts_mig_bakup) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (r *receipts_mig_bakup) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (r *receipts_mig_bakup) Validate(action Action) error {
	return nil
}
